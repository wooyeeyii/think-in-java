 ...
 * input and returns thread count and work queue capacity.
 *
 * @author Niklas Schlimm
 */
public abstract class PoolSizeCalculator {

    private final int SAMPLE_QUEUE_SIZE = 100;
     ...
     * depending on the operating system in use. (e.g. http://www.hyperic.com/products/sigar).
     * The more accurate the CPU time measurement,
     * the more accurate the results for thread count boundaries.
     *
