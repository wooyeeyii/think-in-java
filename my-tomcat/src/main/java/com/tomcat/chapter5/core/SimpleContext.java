...
public class SimpleContext implements Context, Pipeline {
    ...
    public SimpleContext() {
        pipeline.setBasic(new com.tomcat.chapter5.core.SimpleContextValve());
    }

    protected HashMap children = new HashMap();
    protected Loader loader = null;
    protected com.tomcat.chapter5.core.SimplePipeline pipeline = new com.tomcat.chapter5.core.SimplePipeline(this);
