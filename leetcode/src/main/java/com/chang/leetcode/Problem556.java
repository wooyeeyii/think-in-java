...
public class Problem556 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(123456798 == problem.nextGreaterElement(123456789));
        System.out.println(-1 == problem.nextGreaterElement(987654321));
        System.out.println(9199999999L == problem.nextGreaterElement(1999999999));
    }
